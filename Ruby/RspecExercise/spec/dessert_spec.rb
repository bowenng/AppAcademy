...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect {Dessert.new("bad dessert", "bad quantity")}.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      original_ingredients = cake.ingredients.clone
      cake.mix!
      expect(cake.ingredients).not_to eq(original_ingredients)
    end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Jason the Chicken King")
      expect(cake.serve).to include("Chef Jason the Chicken King")
    end
  end
